...
--------------
    class TargetService:
        async def ingest_csv(project_id: UUID, csv_file: ...) -> list[Target]: ...
        async def check_connectivity(target_id: UUID) -> ConnectivityResult: ...
        async def detect_llm_type(target_id: UUID) -> str | None: ...
        async def list_targets(project_id: UUID) -> list[Target]: ...
"""
